<?php
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>', 'redux-framework-demo' ), $v );
    } else {
    ...
    Redux::setSection($opt_name, array(
        ...
        'subsection'=>'true',
        'id'=>'logo',
        'desc'=>'You can change logo from here',
        'fields'=>array(
    ...
    Redux::setSection($opt_name,array(
       'id'=>'set_footer',
        'title'=>'Footer Option',
        'desc'=>'You can chnage footer information from here',
        'subsection'=>true,
        'fields'=>array(
            array(
                ...
                'id'=>'footer_left',
                'type'=>'text',
                'default'=>'©Copyright -2013 domain name- All rights reserved.',
            ),
            array(
                'title'=>'Right section content',
                'id'=>'footer_right',
                'type'=>'text',
                'default'=>'Template by os template',
            ),
        ),
